...
![Aperçu de l'application](src/icon.png)
...
### 🚀 Installation
1. **Prérequis** : Assurez-vous d'avoir [Node.js](https://nodejs.org/) installé sur votre ordinateur.
2. **Téléchargement** : Clonez ce dépôt ou téléchargez les fichiers.
   ```bash
   git clone https://github.com/votre-utilisateur/focus-visuel.git
   ```
